...
|--------------------------------|-----------------------------|
| `random_001` to `random_022`   | `etsi.VehicleCamSendingApp` |
| `default_001` to `default_022` | `etsi.VehicleCamSendingApp` |
| `bus`                          | None (no V2X)               |
...
Writes simulation data to CSV files. These are not the CAM messages used in the dataset but events occurring during
the simulation and are saved for debugging purpose.
